...
## 🏆 **Betyg: G**
📌 **Motivering:** Projektet uppfyller de grundläggande kraven för betyg G. Koden är välstrukturerad och följer etablerade konventioner för frontend-utveckling. Projektet använder React Router för att hantera olika sidor, och det finns en översiktssida för djuren där användaren kan klicka på ett djur för att se mer detaljerad information. Funktionaliteten för att mata djur är implementerad och hanterar även felaktiga bildlänkar korrekt. Styling hanteras med SCSS, vilket uppfyller kravet på att använda en annan teknik än ren CSS.

💡 **Förbättringsförslag:**  
För att uppnå betyget VG skulle projektet behöva implementera användning av context API istället för props för kommunikation mellan komponenter, och använda reducers istället för state för hantering av djur. Det skulle också vara fördelaktigt att inkludera subtila animeringar vid knapptryckningar och sidladdningar för att förbättra användarupplevelsen. Dessutom kan felhantering förbättras genom att inkludera mer detaljerade felmeddelanden och återhämtningsstrategier vid API-anrop.